        ...
        <! -- //////////////////////////////HEADER END//////////////////////////////////////// -->
            ...
            <! -- //////////////////////////////MAIN START//////////////////////////////////////// -->
                <main class="container white-page">
                    <h1 class="t-game2">God of War</h1>
                    <div class="row">
                        <div class="col-lg-9">
                            <div class="section">
                                ...
                                <div class="section">
                                    <p class="description">
                                        Sa vengeance contre les dieux de l'Olympe étant bien derrière lui, Kratos vit
                                        désormais comme un simple habitant du royaume des dieux (et des monstres)
                                        nordiques.
                                        C'est dans ce monde inhospitalier et cruel qu'il doit combattre pour sa
                                        survie... et
                                        apprendre à son fils à en faire de même.
                                    </p>
                                </div>
                                <div class="section">
                                    <div class="d-flex align-items-center">
                                        <h2 class="t-gamePage">God of War</h2>
                                        <span></span>
                                    </div>
                                    <h3 class="t-description">Pénétrez dans le royaume du nord</h3>
                                    ...
                                    <h3 class="t-description">Profitez de votre deuxième chance</h3>
                                    <p class="description2">
                                        Kratos est à nouveau père. En tant que mentor et protecteur d'Atreus, un fils
                                        prêt à
                                        tout pour gagner son respect, Kratos se retrouve contraint de dominer la rage
                                        qui
                                        l'a défini pendant si longtemps alors qu'il explore avec son fils un monde
                                        rempli de
                                        dangers.
                                    </p>
                                    <h3 class="t-description">Voyagez dans un monde sombre peuplé de terribles créatures
                                    </h3>
                                    <p class="description2">
                                        Du marbre et des colonnes d'une Olympe resplendissante aux environnements bruts
                                        des
                                        forêts, montagnes et cavernes de la mythologie nordique pré-viking, ce nouveau
                            ...
                            <div class="section">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="me-3">
                                        <h3 class="t-description">Configuration Minimum</h3>
                            ...
                            <div class="section">
                                ...
                                <p>
                                    AUDIO : anglais, français, allemand, italien, japonais, polonais, portugais,
                                    portugais
                                    (Brésil),
                                    russe, espagnol (Espagne), espagnol (Amérique latine)
                                </p>
                                <p>
                                    TEXTE : anglais, néerlandais, français, allemand, italien, japonais, coréen,
                                    polonais,
                                    portugais,
                                    portugais (Brésil), russe, espagnol (Espagne), espagnol (Amérique latine), turc,
                                    chinois
                                    traditionnel, hongrois, tchèque, grec
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="border-card">
                                <div class="card-game">
                                    <div class="d-flex justify-content-center mb-3">
                                        <img class="logo-game" src="../assets/img/games/god_war_logo.png" alt="">
                                    </div>
                                    <span class="mb-3">
                                        Genre
                                    </span>
                                    <div class="d-flex justify-content-between mb-2">
                                        <span class="kind-game">
                                            Aventure
                                        </span>
                                        <span class="kind-game">
                                            Jeu de rôle
