<footer class="pt-5 pb-5 ps-4 pe-4">
    ...
    <div>
        <p>
            © 2022, Nebula. Tous droits réservés. Nebula et le logo Nebula sont des marques ou des marques déposées de
            Nebula en France et ailleurs. Les autres marques ou noms de produit appartiennent à leurs propriétaires
            respectifs. En dehors de la France, les transactions sont gérées par Nebula, S.à r.l.
        </p>
    </div>
    <div class="d-flex justify-content-between ">
        <div>
            <a class="menu me-2" href="../views/contactPage.php">Contact</a>
