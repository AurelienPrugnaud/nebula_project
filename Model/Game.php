...
class Game {
    ...
    //$sqlQuery = 'SELECT G.id, G.name, G.releaseDate, G.addDate, G.hook, G.price, E.name as editorName, D.name as developperName, I0.name as image0, I5.name as image5, P.id_game AS page FROM game G LEFT JOIN editor E on G.id_editor = E.id LEFT JOIN developper D on G.id_developper = D.id LEFT JOIN image I0 on I0.id_game = G.id AND I0.orderImg = 0 LEFT JOIN image I5 on I5.id_game = G.id and I5.orderImg = 5 LEFT JOIN page P on P.id_game = G.id ORDER BY RAND();';
    ...
    public function getGameById($id) {
        ...
        $sqlQueryGame = 'SELECT G.id, G.name, G.releaseDate, G.youtubeLink, G.addDate, G.hook, G.price, E.name as editorName, D.name as developperName, P.name as pegiName, P.img as pegiImg, I0.name as image0, I1.name as image1, I2.name as image2, I3.name as image3, I4.name as image4, I5.name as image5, PT0.title as title0, PA0.paragraph as para0, PT1.title as title1, PA1.paragraph as para1, PT2.title as title2, PA2.paragraph as para2, PT3.title as title3, PA3.paragraph as para3, PT4.title as title4, PA4.paragraph as para4, PT5.title as title5, PA5.paragraph as para5, PT6.title as title6, PA6.paragraph as para6, PT7.title as title7, PA7.paragraph as para7 FROM game G
        LEFT JOIN editor E on G.id_editor = E.id
        LEFT JOIN developper D on G.id_developper = D.id
        LEFt JOIN pegi P on G.id_pegi = P.id
        LEFT JOIN image I0 on I0.id_game = G.id AND I0.orderImg = 0
    ...
    $sqlQueryRequirement ='SELECT T.name as TypeName, R.name as RequirementName, TRG.minimum, TRG.recomandation FROM type_requirement_game TRG INNER JOIN type T on T.id = TRG.id_type INNER JOIN requirement R on R.id = TRG.id_requirement WHERE TRG.id_game = :id; ';
        ...
        try {
            $game = $this->dbc->select($sqlQueryGame);
